...
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(CalgaryEigenToMeasureImageFilter);
  ...
  itkTypeMacro(CalgaryEigenToMeasureImageFilter, EigenToMeasureImageFilter);
...
protected:
  ...
  virtual ~CalgaryEigenToMeasureImageFilter() {}
